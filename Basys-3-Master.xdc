...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports {resetGameSwitch}]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {resetMatchSwitch}]
...
## LEDs
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports {player2_turn}]
...
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports {player1_turn}]
...
##Buttons
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports placeMarker]
